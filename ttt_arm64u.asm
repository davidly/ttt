...
_minmax_min_move
    ...
    b.le     _minmax_min_loadv_done

    adrp     x1, _next_min
    add      x1, x1, _next_min
    add      x1, x1, x27, lsl #3       ; calculate the function pointer offset
    ldr      x1, [x1]                   ; grab the function pointer
    blr      x1                         ; call it
...
; _next_max
;     dcq _minmax_max_try_1
;     dcq _minmax_max_try_2
;     dcq _minmax_max_try_3
;     dcq _minmax_max_try_4
;     dcq _minmax_max_try_5
;     dcq _minmax_max_try_6
;     dcq _minmax_max_try_7
;     dcq _minmax_max_try_8
;     dcq _minmax_max_loadv_done

_next_min
    dcq _minmax_min_try_1
    dcq _minmax_min_try_2
    dcq _minmax_min_try_3
    dcq _minmax_min_try_4
    dcq _minmax_min_try_5
    dcq _minmax_min_try_6
    dcq _minmax_min_try_7
    dcq _minmax_min_try_8
    dcq _minmax_min_loadv_done
